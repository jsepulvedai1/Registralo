    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('Registralo', style: TextStyle( color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold )),
  ...
  Widget _botonesRedondeados() {
    ...
    return Table(
      children: [
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.blue, Icons.border_all, 'Consultar bien' ),
            _crearBotonRedondeado( Colors.purpleAccent, Icons.directions_bus, 'Bus' ),
          ]
        ),
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.pinkAccent, Icons.shop, 'consejos de prevencion' ),
            _crearBotonRedondeado( Colors.orange, Icons.insert_drive_file, 'File' ),
          ]
        ),
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.blueAccent, Icons.movie_filter, 'Contacto' ),
