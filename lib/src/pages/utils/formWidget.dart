...
class _FormWidgetState extends State<FormWidget> {
  ...
  void initState() {
    ...
    mapIdentifiers['Telefonos Celulres'] = ['Imei', 'N° serie'];
    mapIdentifiers['Computadores Portatiles'] = ['MAC', 'N° serie'];
    mapData['Telefonos Celulres'] = ['Samsung', 'Apple','Huawei','LG'];
    mapData['Camara de videos'] = ['hp', 'huawei'];
    var estimatedValues = [
      "Menor a \$100.000",
      "\$100.000 - \$500.000",
      "\$500.000 - \$100.0000",
  ...
  String currentCategory = 'Telefonos Celulres';
  String dropDownValue2 = 'Samsung';
