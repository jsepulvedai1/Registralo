...
class ContactoPostLogin extends StatefulWidget {
  ContactoPostLogin(): super();
  
  
  @override
  _ContactoPostLoginState createState() => new _ContactoPostLoginState();
...
class _ContactoPostLoginState extends State<ContactoPostLogin> {
